...
#define NRF24_HW_CSN_LOW() nrf24_csn_low()
#define NRF24_HW_CSN_HIGH() nrf24_csn_high()

#define NRF24_HW_CE_LOW() nrf24_ce_low()
#define NRF24_HW_CE_HIGH() nrf24_ce_high()
#define NRF24_HW_CE_PULSE() nrf24_ce_pulse()
